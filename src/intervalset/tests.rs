...
fn test_pow() {
    ...
    test_binary_op(IVS::pow, all_sign_classes_small_and_big(), vec![
        ...
        ("n1s.whl", "<-inf, inf>"),
        ("n1s.m", "{<-2, -0.5>; <0.5, 2>}"),
        ("n1s.p0s", "{<-2, -0.75>; <0.75, 2>}"),
        ("n1s.p0b", "{<-3, -0.5>; <0.5, 3>}"),
        ("n1s.p1s", "{<-4, -0.5>; <0.5, 4>}"),
        ("n1s.p1b", "{<-4, -0.5>; <0.5, 4>}"),
        ("n1s.n0s", "{<-1.5, -0.5>; <0.5, 1.5>}"),
        ("n1s.n0b", "{<-2, -0.25>; <0.25, 2>}"),
        ("n1s.n1s", "{<-2, -0.25>; <0.25, 2>}"),
        ("n1s.n1b", "{<-2, -0.25>; <0.25, 2>}"),
        ("n1s.ss", "{<-4, -0.25>; <0.25, 4>}"),
        ("n1s.sb", "{<-4, -0.25>; <0.25, 4>}"),
        ("n1b.whl", "<-inf, inf>"),
        ("n1b.m", "{<-2, -0.5>; <0.5, 2>}"),
        ("n1b.p0s", "{<-2, -1>; <1, 2>}"),
        ("n1b.p0b", "{<-3, -1>; <1, 3>}"),
        ...
        ("n1b.p1b", "{<-4, -1.5>; <1.5, 4>}"),
        ("n1b.n0s", "{<-1, -0.5>; <0.5, 1>}"),
        ("n1b.n0b", "{<-1, -0.25>; <0.25, 1>}"),
        ("n1b.n1s", "{<-1, -0.25>; <0.25, 1>}"),
        ("n1b.n1b", "{<-0.75, -0.25>; <0.25, 0.75>}"),
        ("n1b.ss", "{<-4, -0.25>; <0.25, 4>}"),
        ("n1b.sb", "{<-4, -1.5>; <-0.75, -0.25>; <0.25, 0.75>; <1.5, 4>}"),
        ("ss.whl", "<-inf, inf>"),
        ("ss.m", "{<-2, -0.5>; <0.5, 2>}"),
        ("ss.p0s", "{<-2, -0.75>; <0.75, 2>}"),
        ("ss.p0b", "{<-3, -0.5>; <0.5, 3>}"),
        ("ss.p1s", "{<-4, -0.5>; <0.5, 4>}"),
        ("ss.p1b", "{<-4, -0.5>; <0.5, 4>}"),
        ("ss.n0s", "{<-1.5, -0.5>; <0.5, 1.5>}"),
        ("ss.n0b", "{<-2, -0.25>; <0.25, 2>}"),
        ("ss.n1s", "{<-2, -0.25>; <0.25, 2>}"),
        ("ss.n1b", "{<-2, -0.25>; <0.25, 2>}"),
        ("ss.ss", "{<-4, -0.25>; <0.25, 4>}"),
        ("ss.sb", "{<-4, -0.25>; <0.25, 4>}"),
        ("sb.whl", "<-inf, inf>"),
        ("sb.m", "{<-2, -0.5>; <0.5, 2>}"),
        ...
        ("sb.p1b", "{<-4, -1.5>; <1.5, 4>}"),
        ("sb.n0s", "{<-1, -0.5>; <0.5, 1>}"),
        ("sb.n0b", "{<-1, -0.25>; <0.25, 1>}"),
        ("sb.n1s", "{<-1, -0.25>; <0.25, 1>}"),
        ("sb.n1b", "{<-0.75, -0.25>; <0.25, 0.75>}"),
        ("sb.ss", "{<-4, -0.25>; <0.25, 4>}"),
        ("sb.sb", "{<-4, -1.5>; <-0.75, -0.25>; <0.25, 0.75>; <1.5, 4>}"),
    ], false);
}
