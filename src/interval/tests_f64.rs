...
fn test_size() {
    ...
    assert_str_eq!("<2, 2.0000000000000004>", iv!("<-1.1, 0.9>").size());
}
...
fn test_exp() {
    ...
    test_unary_op(IV::exp, all_sign_classes(), vec![
        ("nan", "NaN"),
        ("whl", "<0, inf>"),
        ("m", "<0.36787944117144233, 2.718281828459045>"),
        ("z", "1"),
        ("p0", "<1, 2.718281828459045>"),
        ("p1", "<2.718281828459045, 7.38905609893065>"),
        ("n0", "<0.36787944117144233, 1>"),
        ("n1", "<0.1353352832366127, 0.36787944117144233>"),
    ], false);
}
...
fn test_pow() {
    ...
    test_binary_op(IV::pow, all_sign_classes_small_and_big(), vec![
        ...
        ("p0s.p0s", "<0, 1>"),
        ("p0s.p0b", "<0, 1>"),
        ("p0s.p1s", "<0, 0.8059274488676564>"),
        ("p0s.p1b", "<0, 0.649519052838329>"),
        ("p0s.n0s", "<1, inf>"),
        ("p0s.n0b", "<1, inf>"),
        ("p0s.n1s", "<1.2408064788027993, inf>"),
        ("p0s.n1b", "<1.5396007178390019, inf>"),
        ("p0b.whl", "<0, inf>"),
        ("p0b.m", "<0, inf>"),
        ("p0b.p0s", "<0, 1.3554030054147672>"),
        ("p0b.p0b", "<0, 1.8371173070873836>"),
        ("p0b.p1s", "<0, 2.25>"),
        ("p0b.p1b", "<0, 2.25>"),
        ("p0b.n0s", "<0.7377879464668811, inf>"),
        ("p0b.n0b", "<0.5443310539518172, inf>"),
        ("p0b.n1s", "<0.4444444444444444, inf>"),
        ("p0b.n1b", "<0.4444444444444444, inf>"),
        ("p1s.whl", "<0, inf>"),
        ("p1s.m", "<0.5, 2>"),
        ("p1s.p0s", "<0.8059274488676564, 1.681792830507429>"),
        ("p1s.p0b", "<0.649519052838329, 2.8284271247461903>"),
        ("p1s.p1s", "<0.5625, 4>"),
        ("p1s.p1b", "<0.5625, 4>"),
        ("p1s.n0s", "<0.5946035575013605, 1.2408064788027995>"),
        ("p1s.n0b", "<0.35355339059327373, 1.539600717839002>"),
        ("p1s.n1s", "<0.25, 1.777777777777778>"),
        ("p1s.n1b", "<0.25, 1.777777777777778>"),
        ("p1b.whl", "<0, inf>"),
        ("p1b.m", "<0.5, 2>"),
        ("p1b.p0s", "<1, 1.681792830507429>"),
        ("p1b.p0b", "<1, 2.8284271247461903>"),
        ("p1b.p1s", "<1.3554030054147672, 4>"),
        ("p1b.p1b", "<1.8371173070873836, 4>"),
        ("p1b.n0s", "<0.5946035575013605, 1>"),
        ("p1b.n0b", "<0.35355339059327373, 1>"),
        ("p1b.n1s", "<0.25, 0.7377879464668812>"),
        ("p1b.n1b", "<0.25, 0.5443310539518174>"),
        ("n0s.whl", "<-inf, inf>"),
        ("n0s.m", "<-inf, inf>"),
        ("n0s.p0s", "<-1, 1>"),
        ("n0s.p0b", "<-1, 1>"),
        ("n0s.p1s", "<-0.8059274488676564, 0.8059274488676564>"),
        ("n0s.p1b", "<-0.649519052838329, 0.649519052838329>"),
        ("n0s.n0s", "<-inf, inf>"),
        ("n0s.n0b", "<-inf, inf>"),
        ("n0s.n1s", "<-inf, inf>"),
        ("n0s.n1b", "<-inf, inf>"),
        ("n0b.whl", "<-inf, inf>"),
        ("n0b.m", "<-inf, inf>"),
        ("n0b.p0s", "<-1.3554030054147672, 1.3554030054147672>"),
        ("n0b.p0b", "<-1.8371173070873836, 1.8371173070873836>"),
        ("n0b.p1s", "<-2.25, 2.25>"),
        ("n0b.p1b", "<-2.25, 2.25>"),
        ("n0b.n0s", "<-inf, inf>"),
        ("n0b.n0b", "<-inf, inf>"),
        ...
        ("n1s.whl", "<-inf, inf>"),
        ("n1s.m", "<-2, 2>"),
        ("n1s.p0s", "<-1.681792830507429, 1.681792830507429>"),
        ("n1s.p0b", "<-2.8284271247461903, 2.8284271247461903>"),
        ("n1s.p1s", "<-4, 4>"),
        ("n1s.p1b", "<-4, 4>"),
        ("n1s.n0s", "<-1.2408064788027995, 1.2408064788027995>"),
        ("n1s.n0b", "<-1.539600717839002, 1.539600717839002>"),
        ("n1s.n1s", "<-1.777777777777778, 1.777777777777778>"),
        ("n1s.n1b", "<-1.777777777777778, 1.777777777777778>"),
        ("n1b.whl", "<-inf, inf>"),
        ("n1b.m", "<-2, 2>"),
        ("n1b.p0s", "<-1.681792830507429, 1.681792830507429>"),
        ("n1b.p0b", "<-2.8284271247461903, 2.8284271247461903>"),
        ("n1b.p1s", "<-4, 4>"),
        ("n1b.p1b", "<-4, 4>"),
        ("n1b.n0s", "<-1, 1>"),
        ("n1b.n0b", "<-1, 1>"),
        ("n1b.n1s", "<-0.7377879464668812, 0.7377879464668812>"),
        ("n1b.n1b", "<-0.5443310539518174, 0.5443310539518174>"),
    ], false);
}
